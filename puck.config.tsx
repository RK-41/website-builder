...
import {
  ...
  Header,
  HeaderProps,
} from './app/components/templateA/Header';
import {
  HeroSectionAProps,
  defaultButtons,
  HeroSectionA,
} from './app/components/templateA/HeroSectionA';
import {
  Categories,
  CategoriesProps,
  defaultSectionButtons,
} from './app/components/templateA/Categories';
import {
  ContactSection,
  ContactSectionProps,
  defaultSubmitButton,
} from './app/components/templateA/ContactSection';
  ...
  components: {
        ...
        return (
          <>
            ...
            <Button
              variant="contained"
              sx={{ color: color }}
              onCanPlay={() => console.log('btn clicked')}
            >
              {title}
            </Button>
            ;
    ...
    Categories: {
      ...
      defaultProps: {
        ...
        sectionImage:
          'https://edmingle.b-cdn.net/edmingle_websitebuilder/sitebuilder/assets/designs/images/edmingle/meeting-clipped.png',
        backgroundColor: '#ffffff',
      },
