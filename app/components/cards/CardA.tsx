import { Card, CardContent, Typography, Avatar, Chip, Box, Link as MuiLink } from "@mui/material";
  ...
  return (
    ...
    >
      ...
      <Box mt={2} display="flex" justifyContent="space-between" alignItems="center">
        <MuiLink href={readMoreUrl} color="primary" underline="hover" fontWeight={500}>
          Read more
        </MuiLink>
