        ...
        {faqs.length > 0 && faqs.map(({ question, answer }, index) => (
          <Accordion
            ...
            sx={{
              ...
              bgcolor: expanded === index ? "action.selected" : "background.paper",
            }}
          >
            <AccordionSummary
              expandIcon={
                expanded === index ? (
                  <Remove sx={{ bgcolor: "primary.main", color: "common.white", borderRadius: "50%" }} />
                ) : (
                  <ExpandMore sx={{ bgcolor: "primary.main", color: "common.white", borderRadius: "50%" }} />
                )
              }
              sx={{
                px: 4,
