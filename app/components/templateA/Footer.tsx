...
export const FooterA: React.FC<FooterAProps> = ({
  ...
  return (
    <Box
      component="footer"
      sx={{ bgcolor: backgroundColor, color: textColor, py: 8 }}
    >
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          >
            ...
            <Typography variant="body2">{getInTouchText}</Typography>
          </Grid>
          ...
          <Grid component="div" size={{ xs: 12, md: 3 }}>
            ...
            <Typography variant="body2">{chatText}</Typography>
            <Link
              href={`mailto:${chatEmail}`}
              color="inherit"
              underline="hover"
            >
              <Typography variant="body2">{chatEmail}</Typography>
            </Link>
          </Grid>
          ...
          <Grid component="div" size={{ xs: 12, md: 3 }}>
            ...
            <Typography variant="body2">{officeText}</Typography>
            <Typography variant="body2">{officeAddress}</Typography>
          </Grid>
  ...
  fields: {
    ...
    textColor: {
      ...
      render: ({ value, onChange }: { value: any; onChange: any }) => (
        <MuiColorInput value={value} onChange={onChange} label="Text Color" />
      ),
    } as any,
    backgroundColor: {
      type: 'custom',
